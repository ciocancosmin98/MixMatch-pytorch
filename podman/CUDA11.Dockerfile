...
RUN pip install transformers==4.15.0 pandas==1.3.5 tqdm==4.62.3 sentencepiece==0.1.96 scikit-learn==1.0.2 swifter==1.0.9 matplotlib==3.4.1 tensorboard==2.9.1 opencv-python==4.6.0.66
